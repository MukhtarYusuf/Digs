...
class MukMessageAccessoryView: UIView {
    
    // MARK: Outlets
    @IBOutlet var mukContentView: UIView!
    @IBOutlet weak var mukMessageTextField: MukTextField!
    @IBOutlet weak var mukSendButton: UIButton!
    ...
    private func mukSetup() {
        mukContentView = Bundle.main.loadNibNamed("MukMessageAccessoryView", owner: self, options: nil)?.first as? UIView
